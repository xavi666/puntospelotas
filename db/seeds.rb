...
Game.create(local_team_id: 2, visitant_team_id: 3, game_date: DateTime.parse("06/06/2016 14:14"), stage: "Jornada 1", comunio_url: "http://www.comuniazo.com/liga-bbva/1511/valencia-real-sociedad")
